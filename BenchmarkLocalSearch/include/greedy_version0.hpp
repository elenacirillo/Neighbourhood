#ifndef GREEDY_VERSION0_HH
#define GREEDY_VERSION0_HH
...
*
    ...
    2) each job in the ordered queue is assigned to:
       ...
       2.2) a new node, equipped with the optimal configuration in terms of
            ...
            if possible
       2.3) a suboptimal configuration available on the first already opened 
            node with residual space, if possible
...
class Greedy_version0: public Greedy {
...
public:
  ...
  *
  */
  Greedy_version0 (const std::string&, const std::string&, const std::string&, 
                   const std::string&, const std::string&);

  /* destructor
  */
  virtual ~Greedy_version0 (void) = default;

};

#endif /* GREEDY_VERSION0_HH */